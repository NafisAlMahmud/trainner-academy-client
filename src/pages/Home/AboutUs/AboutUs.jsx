      ...
      <div className="grid md:grid-cols-2">
        ...
        <div className="md:w-3/4">
          ...
          <p className="pt-8">
            ...
            technique, we have the resources and expertise to help you achieve
            your goals. At our website, we understand the importance of proper
            training and the impact it can have on your performance. That's why
